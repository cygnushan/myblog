...
article_types = {u'开发语言': ['Python', 'C', 'JavaScript', 'HTML/CSS'],
                 u'Web开发': ['Flask', 'Django'],
                 u'数据库': ['MySQL', 'Redis'],
                 u'Linux世界': [u'Linux运维', 'Ubuntu'],
                 u'开源硬件': [u'树莓派', u'其它'],
                 u'生活': [u'天文', u'摄影', u'旅行'],}
...
class Menu(db.Model):
    ...
    @staticmethod
    def insert_menus():
        menus = [u'开发语言', u'Web开发', u'数据库', u'Linux世界', u'开源硬件', u'生活']
        for name in menus:
            menu = Menu(name=name)
            db.session.add(menu)
            db.session.commit()
...
class ArticleType(db.Model):
    ...
    def insert_articleTypes():
        articleTypes = ['Python', 'HTML/CSS', 'JavaScript', 'C',
                        'Django', 'Flask', 'MySQL', 'Redis', 'Ubuntu',
                        u'Linux运维', u'其他', u'相册',
                        u'树莓派', u'天文', u'摄影',
                        u'旅行']
